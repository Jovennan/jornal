...
class NoticiasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create noticia" do
    assert_difference('Noticia.count') do
      post noticias_url, params: { noticia: { autor: @noticia.autor, conteudo: @noticia.conteudo, imagem: @noticia.imagem, titulo: @noticia.titulo } }
    end
  ...
  test "should update noticia" do
    patch noticia_url(@noticia), params: { noticia: { autor: @noticia.autor, conteudo: @noticia.conteudo, imagem: @noticia.imagem, titulo: @noticia.titulo } }
